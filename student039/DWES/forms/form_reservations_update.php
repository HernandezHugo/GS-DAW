...
include($_SERVER['DOCUMENT_ROOT'] . '/student039/dwes/db/db_reservations_update.php');
...
<div class="container bg-light mt-3 w-75">
    <form class="mt-3 " action="" method="POST">
        ...
        <select class="form-select" aria-label="Default select example" name="id_client">
            <option value="<?php echo $id_client; ?>" selected><?php echo $client_selected['firstname'] . ' ' . $client_selected['surname']; ?></option>
        ...
        <select id="show_rooms_reserv_ins" class="form-select" aria-label="Default select example" name="id_room">
            <option value="<?php echo $id_room ?? ''; ?>" selected><?php echo $id_room ?? ''; ?></option>
        </select>

        <label class="form-label mt-3">Initial date</label>
        <input id="initial_date_reserv_upd_ins" onchange="getPrice()" type="date" name="initial_date" value="<?php echo $initial_date; ?>">
        <label class="form-label mt-3">Final date</label>
        <input id="final_date_reserv_upd_ins" onchange="getPrice()" type="date" name="final_date" value="<?php echo $final_date; ?>">
        <br>
        ...
        <input id="show_price_reserv_upd_ins" type="number" name="total_price" value="<?php echo $total_price; ?>" class="form-control form-control-sm">
